...
[[ ! -z "$NET3_MODE" ]] && add_${NET3_MODE}_iface "$NET3_DEV" "$NET3_VF" "$NET3_MACADDR" "$NET3_BUS" "$NET3_ADDR"
[[ ! -z "$NET4_MODE" ]] && add_${NET4_MODE}_iface "$NET4_DEV" "$NET4_VF" "$NET4_MACADDR" "$NET4_BUS" "$NET4_ADDR"
