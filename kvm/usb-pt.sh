...
-device vfio-pci,host=$USBPCI.0,bus=$USBPCI_BUS,addr=0.0
)
...
add_vpci USBPCI_BUS $USB_ROOT_PORT
QEMU_OPTS+=(
-device vfio-pci,host=$USBPCI_1.0,bus=$USBPCI_BUS,addr=0
)
...
add_vpci USBPCI_BUS $USB_ROOT_PORT 
QEMU_OPTS+=(
-device vfio-pci,host=$USBPCI_2.0,bus=$USBPCI_BUS,addr=0.0
)
